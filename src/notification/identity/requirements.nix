...
#
# COMMAND:
#   pypi2nix -v -C /tmp/release-services-sx8o4k6q/src/notification/identity/../../../tmp/pypi2nix -V 3.7 -O ../../../nix/requirements_override.nix -E postgresql -e vcversioner -e pytest-runner -e setuptools-scm -r requirements.txt -r requirements-dev.txt
#
